...
- Before committing or pushing, recommend whether the change should go direct to main or through a branch + PR. Use direct-to-main only for tiny low-risk local fixes; use branch + PR for behavior-changing, structural, shared, public, dependency, security, or hard-to-revert changes.
